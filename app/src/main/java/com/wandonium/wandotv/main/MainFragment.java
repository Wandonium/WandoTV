...
import com.wandonium.wandotv.error.BrowseErrorActivity;
import com.wandonium.wandotv.details.DetailsActivity;
import com.wandonium.wandotv.models.Movie;
import com.wandonium.wandotv.models.MovieList;
...
import com.wandonium.wandotv.repository.PlaylistRepository;
...
//                loadRows();
            ...
            protected Void doInBackground(Void... voids) {
                Log.i(TAG, "Starting to get Playlist page from youtube:");
                PlaylistRepository repository = PlaylistRepository.getInstance();
                PlaylistPage playlistPage = null;
                do {
                    try {
                        String token = playlistPage == null ? null : playlistPage.getNextPageToken();
                        playlistPage = repository.getPlaylists(token);
                        Log.i(TAG, "Playlist page from youtube: " + playlistPage);
                        String jsonString = null;

                        for(Playlist p: playlistPage.getPlaylists()) {
...
//                        mLastError[0] = e;
                        cancel(true);
                        Log.e(TAG, "Error getting playlists from youtube: " + e.getMessage());
                        break;
                    }
                } while (playlistPage.getNextPageToken() != null);
                return null;
            }
        }.execute();
    }
